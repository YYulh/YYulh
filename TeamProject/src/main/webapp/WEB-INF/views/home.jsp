...
<!-- 제품 리스트  -->
  <c:forEach var = "vo" items = "${list}">
  	<input type="hidden" value ="${vo.prod_no}" name = "no">
    	<ul class = "list">
    		<li ><a href="${pageContext.request.contextPath}/member/product/contentForm?no=${vo.prod_no}">
    		<img alt="" src="${pageContext.request.contextPath }/resources/upload/${vo.pp_filename}" width="400"></a></li>
    	    ...
    	    <li><div>★<fmt:formatNumber value="${vo.prod_rate}" pattern=".0"/>(${vo.prod_view})</div></li>
  		</ul>
  </c:forEach>
</div>
